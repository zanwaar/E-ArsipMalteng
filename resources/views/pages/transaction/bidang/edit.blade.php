...
@section('content')
<x-breadcrumb :values="[__('menu.transaction.menu'), __('menu.transaction.bidang_letter'), __('menu.general.edit')]">
</x-breadcrumb>

<div class="card mb-4">
    <form action="{{ route('transaction.bidang.update', $data) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body row">
            ...
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                <x-input-form :value="$data->nomor_dokument" name="nomor_dokument" :label="__('model.letter.nomor_surat')" />
            </div>
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                <x-input-form :value="$data->bidang" name="bidang" :label="__('model.letter.bidang')" />
            </div>
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
            ...
            <div class="col-sm-12 col-12 col-md-6 col-lg-12">
                <x-input-form :value="date('Y-m-d', strtotime($data->tgl_dokument))" name="tgl_dokument" :label="__('model.letter.tgl')" type="date" />
            </div>

                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="filter" name="filter">
                            <option value="tgl_dokument" @selected(old('filter', $filter)=='tgl_dokument' )>{{ __('model.letter.tgl_dokument') }}</option>
                            <option value="tgl_diterima" @selected(old('filter', $filter)=='tgl_diterima' )>{{ __('model.letter.tgl_diterima') }}</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{ route('agenda.incoming.print') . '?' . $query }}" target="_blank" class="btn btn-primary">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>{{ __('model.letter.tgl_dokument') }}</th>
                </tr>
            </thead>
            @if($data)
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('transaction.incoming.show', $agenda) }}">{{ $agenda->nomor_dokument }}</a>
                    </td>

...
<div class="card mb-4">
    <form action="{{ route('transaction.incoming.update', $data) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body row">
            ...
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                <x-input-form :value="$data->pengirim" name="pengirim" :label="__('model.letter.from')" />
            </div>
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
            ...
            <div class="col-sm-12 col-12 col-md-6 col-lg-6">
                <x-input-form :value="date('Y-m-d', strtotime($data->tgl_diterima))" name="tgl_diterima" :label="__('model.letter.tgl_diterima')" type="date" />
            </div>

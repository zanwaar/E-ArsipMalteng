...
<script>
    ...
    $.ajax({
            ...
            success: function(response) {
                ...
                countElement.innerHTML = `<a href="{{ route('disposisi') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-bell"></i>
                <div >Surat Disposisi</div>
            </a>
            <span style="right: 24px; top: 12px;;" class="position-absolute badge bg-label-danger" >${count}</span>`;
                } else {
                    const countElement = document.getElementById('count-display');

        ...
        <div class="d-flex justify-content-between flex-column flex-sm-row">
            <div>
                ...
                <small>
                    ...
                    <a href="{{ route('transaction.incoming.show', $letter) }}" class="fw-bold">{{ $letter->nomor_dokument }}</a>
                    @else
                    <a href="{{ route('transaction.outgoing.show', $letter) }}" class="fw-bold">{{ $letter->nomor_dokument }}</a>
                    @endif
                </small>
            </div>
            ...
            <i class="bx bxs-file-png display-5 text-primary"></i>
            @elseif(in_array(strtolower($extension), ['jpeg', 'jpg']))
            <i class="bx bxs-file-jpg display-5 text-primary"></i>
            @else

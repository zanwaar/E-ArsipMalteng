    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.bidang.*') ? 'active' : '' }}">
                    <a href="{{ route('transaction.bidang.index') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.transaction.bidang_letter') }}">{{ __('menu.transaction.bidang_letter') }}</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.bidang') ? 'active' : '' }}">
                    <a href="{{ route('agenda.bidang') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.agenda.bidang_letter') }}">{{ __('menu.agenda.bidang_letter') }}</div>
                    </a>
                </li>
            </ul>
        </li>
        <li id="count-display" class="position-relative menu-item {{ \Illuminate\Support\Facades\Route::is('disposisi') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('gallery.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('gallery.bidang') ? 'active' : '' }}">
                    <a href="{{ route('gallery.bidang') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.gallery.bidang_letter') }}">{{ __('menu.gallery.bidang_letter') }}</div>
                    </a>
                </li>
            </ul>
        </li>
